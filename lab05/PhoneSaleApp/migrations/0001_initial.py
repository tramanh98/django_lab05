...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Brand',
            fields=[
                ('idBrand', models.CharField(max_length=20, primary_key=True, serialize=False, unique=True, validators=[django.core.validators.MinLengthValidator(3, message='ID must have at least 3 characters')])),
        ...
        migrations.CreateModel(
            name='Product',
            fields=[
                ('idProduct', models.CharField(max_length=20, primary_key=True, serialize=False, unique=True, validators=[django.core.validators.MinLengthValidator(3, message='Id must have at least 3 characters')])),
